...
int main() {
	...
	/*                               Printing the values                             */
	cout << "Sides of the triangles are: " << setw(32) << fixed << setprecision(2) << left << side1 << endl;
	cout << right << setw(32) << fixed << setprecision(2) << side2 << endl;
	cout << right << setw(32) << fixed << setprecision(2) << side3 << endl;
